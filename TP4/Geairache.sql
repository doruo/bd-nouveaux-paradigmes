DROP TYPE IF EXISTS employe_type FORCE;
DROP TYPE IF EXISTS voiture_type FORCE;
DROP TYPE IF EXISTS ville_type FORCE;
DROP TYPE IF EXISTS client_type FORCE;
DROP TYPE IF EXISTS projet_type FORCE;

DROP TABLE IF EXISTS Oraux CASCADE CONSTRAINT;
DROP TABLE IF EXISTS UV CASCADE CONSTRAINT;
DROP TABLE IF EXISTS Etudiants CASCADE CONSTRAINT;
DROP TABLE IF EXISTS Classes CASCADE CONSTRAINT;
DROP TABLE IF EXISTS Profs CASCADE CONSTRAINT;
